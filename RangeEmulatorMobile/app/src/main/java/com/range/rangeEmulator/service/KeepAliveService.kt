package com.range.rangeEmulator.service
...
import com.range.rangeEmulator.ui.activity.MainActivity
...
class KeepAliveService : Service() {
    ...
    override fun onCreate() {
        ...
        try {
            ...
            wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "RangeEmulator::KeepAlive")
            wakeLock?.acquire(24 * 60 * 60 * 1000L)

            val wifiManager = applicationContext.getSystemService(Context.WIFI_SERVICE) as WifiManager
            wifiLock = wifiManager.createWifiLock(WifiManager.WIFI_MODE_FULL_HIGH_PERF, "RangeEmulator::WifiKeepAlive")
            wifiLock?.acquire()
        } catch (e: Exception) {
